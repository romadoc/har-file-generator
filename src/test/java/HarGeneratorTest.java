...
public class HarGeneratorTest {
    ...
    public void generateHarTest() {
       //выполнение тестового сценария. заменить на свой
        open("http://google.com"); //если open() осуществляется при загрузке фрейморка, прописать запуск проксисервера
